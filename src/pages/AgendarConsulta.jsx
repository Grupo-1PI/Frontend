...
export function AgendarConsulta() {
  const { data, error, criarAgendamento } = useAgendamentosData();
  ...
  const [agendaExcecoes, setAgendaExcecoes] = useState(() => data.agendaExcecoes);
  ...
  useEffect(() => {
    ...
    setAgendaExcecoes(data.agendaExcecoes);
